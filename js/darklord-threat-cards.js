    ...
    plague_well: {
      ...
      choices: {
        ...
        right: choice("Salvage what you can", "survival", 3, 3, {
          failure: result("The rot spreads through your provisions.", [loseFood(1), damage(1)]),
    ...
    rot_luck: {
      ...
      choices: {
        left: choice("Shake it off", "spirit", 5, 4, {
          failure: result("The curse bites deep and keeps circling.", [reduceModifier(2), damage(1)]),
